...
@ValidationDecorator(FRICTION_ANGLE_KLEVEN)
def friction_angle_kleven(sigma_vo_eff,relative_density,Ko=0.5,
                          max_friction_angle=45.0,fail_silently=True,**kwargs):
    ...
    :param sigma_vo_eff: Effective vertical stress (:math:`\\sigma \\prime _{vo}`) [kPa] -  - Suggested range: 10.0<=sigma_vo_eff<=800.0
    :param relative_density: Relative density of sand (:math:`D_r`) [Percent] -  - Suggested range: 40.0<=relative_density<=100.0
    :param Ko: Coefficient of lateral earth pressure at rest (:math:`K_o`) [-] (optional, default=0.5) - Suggested range: 0.3<=Ko<=2.0
    :param max_friction_angle: The maximum allowable effective friction angle (:math:`\\phi \\prime _{max}`) [deg] (optional, default=45.0)
    
    :returns:   Peak drained friction angle (:math:`\\phi_d`) [deg], Mean effective stress (:math:`\\sigma \\prime _m`) [kPa]
